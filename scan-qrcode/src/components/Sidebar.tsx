      ...
      <ul className="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <Link
            href="/scan"
            className={`nav-link ${
              pathname === "/scan" ? "active" : "link-body-emphasis"
            }`}
            data-title="Scan QR"
          >
            <svg className="bi pe-none me-2" width="16" height="16">
        ...
        <li>
          <Link
            href="/checkin-result"
            className={`nav-link ${
              pathname === "/checkin-result" ? "active" : "link-body-emphasis"
            }`}
        ...
        {user && user.roles.some(role=> role == "admin") && (
          <li>
            <Link
              href="/sessions"
              className={`nav-link ${
                pathname === "/sessions" ? "active" : "link-body-emphasis"
              }`}
              data-title="users"
            >
              <svg className="bi pe-none me-2" width="16" height="16">
        ...
        {user && user.roles.some(role=> role == "admin") && (
          <li>
            <Link
              href="/groups"
              className={`nav-link ${
                pathname === "/groups" ? "active" : "link-body-emphasis"
              }`}
              data-title="users"
            >
              <svg className="bi pe-none me-2" width="16" height="16">
        ...
        <li>
          <Link
            ...
            onClick={onLogout}
            className={`nav-link ${
              pathname === "/login" ? "active" : "link-body-emphasis"
            }`}
            data-title="logout"
          >
            <svg className="bi pe-none me-2" width="16" height="16">

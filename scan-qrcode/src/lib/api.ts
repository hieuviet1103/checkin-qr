...
export const groupAPI = {
  ...
  // Tạo group mới
  createGroup: async (groupData: { group_name: string, latitude?: number, longitude?: number }) => {
    const response = await api.post('/groups', groupData);
    return response.data;
  },

  // Cập nhật group
  updateGroup: async (id: string, groupData: { group_name: string, latitude?: number, longitude?: number }) => {
